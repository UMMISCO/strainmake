...
TEST_ASSEMBLY = "workflow/scripts/test/data/assembly/before_deduplicate_contigs_name.fna"
...
class TestMegahitFastaHeaderRename(unittest.TestCase):
    ...
    def test_replace_spaces_in_fasta(self):
        ...
        expected_sequence_names = ["contig.A",
                                   "contig.B",
                                   "contig.C"]
        ...
        self.assertEqual(file_md5, TEST_ASSEMBLY_md5, 
                         f"Test assembly {TEST_ASSEMBLY} has been altered (md5: {file_md5})")
        
        output_file = "workflow/scripts/test/data/assembly/after_deduplicate_contigs_name.fna"
        ...
        self.assertEqual(sequence_names, expected_sequence_names,
