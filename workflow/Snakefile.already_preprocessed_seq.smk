...
include: "rules/00_databases.smk"
...
rule all:
        input:
            ...
            expand("results/10_strain_profiling/inStrain/{ani}/{assembler}/compare",
                   assembler = ASSEMBLER + HYBRID_ASSEMBLER + ASSEMBLER_LR, ani = DEREPLICATED_GENOMES_THRESHOLD_TO_PROFILE),
            #      -> Floria
