...
seqkit sample -n 800000 --rand-seed 202400 ${RUN}_1.fastq.gz \
    | gzip -c > ${RUN}_1_subsampled.fastq.gz
seqkit sample -n 800000 --rand-seed 202400 ${RUN}_2.fastq.gz \
    | gzip -c > ${RUN}_2_subsampled.fastq.gz

seqkit sample -n 800000 --rand-seed 202400 ${RUN2}_1.fastq.gz \
    | gzip -c > ${RUN2}_1_subsampled.fastq.gz
seqkit sample -n 800000 --rand-seed 202400 ${RUN2}_2.fastq.gz \
    | gzip -c > ${RUN2}_2_subsampled.fastq.gz

seqkit sample -n 800000 --rand-seed 202400 ${RUN3}_1.fastq.gz \
    | gzip -c > ${RUN3}_1_subsampled.fastq.gz
seqkit sample -n 800000 --rand-seed 202400 ${RUN3}_2.fastq.gz \
    | gzip -c > ${RUN3}_2_subsampled.fastq.gz

# removing original .fastq.gz
rm ${RUN}_1.fastq.gz ${RUN}_2.fastq.gz
rm ${RUN2}_1.fastq.gz ${RUN2}_2.fastq.gz
rm ${RUN3}_1.fastq.gz ${RUN3}_2.fastq.gz
...
mv data/${RUN3}_1_subsampled.fastq.gz data/${RUN3}_1.fastq.gz
mv data/${RUN3}_2_subsampled.fastq.gz data/${RUN3}_2.fastq.gz